...
import BookingDialog from './BookTableDialogue';// Import the new component

const Navbar = () => {
    const [isMenuOpen, setIsMenuOpen] = useState(false);
    const [isBookingOpen, setIsBookingOpen] = useState(false); // State for booking dialog
    ...
    return (
        <>
            <div className='w-full h-[80px] md:h-[100px] bg-white flex justify-center items-center   z-50 shadow-sm md:shadow-none'>
                ...
                {isMenuOpen && (
                    <div className='md:hidden absolute top-[80px] left-0 w-full bg-white shadow-md py-10 z-50 h-screen px-4 flex flex-col items-center gap-6'>
                        ...
                        <button 
                            className='button-variant w-full max-w-[200px]'
                            onClick={openBookingDialog}
                        >
                            Book a Table
                        </button>
            ...
            {/* Booking Dialog */}
            <BookingDialog isOpen={isBookingOpen} onClose={closeBookingDialog} />
        </>
    );
};
